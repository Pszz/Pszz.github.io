 ...
 * md5 编码
 */
sky.define("./data/md5",function(require,exports){
	...
	exports.hex = function(s){return binl2hex(core_md5(str2binl(s),s.length*chrsz));};
	exports.b64 = function(s){return binl2b64(core_md5(str2binl(s),s.length*chrsz));};
	exports.str = function(s){return binl2str(core_md5(str2binl(s),s.length*chrsz));};
	exports.mac_hex = function(key,data){return binl2hex(core_hmac_md5(key,data));};
	exports.mac_b64 = function(key,data){return binl2b64(core_hmac_md5(key,data));};
	exports.mac_str = function(key,data){return binl2str(core_hmac_md5(key,data));};
});