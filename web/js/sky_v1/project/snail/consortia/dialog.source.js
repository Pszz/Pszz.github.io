sky.define('./project/snial/consortia/dialog', ['./widget/kite'], function(require,dialog){
    ...
    function prompt(str,buttons,string_str,focus){
        return this.create(replaceText(string_str,getOptContent(str,buttons)),focus).offset(0.5,0.5).drag('title').bind('destroy_vclick',destroy);
    }
